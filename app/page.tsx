...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#070b18] text-white">
      ...
      <section className="relative border-b border-white/5">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 px-4 pb-24 pt-16 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:px-8 lg:pb-28 lg:pt-24">
          <div>
            ...
            <h1 className="mt-6 text-4xl font-bold leading-[1.03] tracking-tight sm:text-6xl lg:text-7xl">Turn every message into a<span className="block bg-gradient-to-r from-violet-300 via-fuchsia-300 to-cyan-300 bg-clip-text text-transparent">business opportunity.</span></h1>
      ...
      <section className="py-20"><div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"><div className="grid gap-6 rounded-[30px] border border-white/10 bg-gradient-to-br from-violet-600/15 via-[#11172b] to-cyan-500/10 p-8 md:grid-cols-[1fr_auto] md:items-center md:p-12"><div><Badge className="bg-white/10 text-white hover:bg-white/10">BUILT FOR BUSINESS</Badge><h2 className="mt-4 text-3xl font-bold sm:text-4xl">Your AI does not just answer. It helps move the customer journey forward.</h2><p className="mt-4 max-w-2xl text-slate-300">Answer → qualify → capture → follow up → book → hand over to your team when needed.</p></div><div className="grid grid-cols-1 gap-3 text-center sm:grid-cols-3"><div className="rounded-xl border border-white/10 bg-black/10 p-4"><Zap className="mx-auto h-5 w-5 text-yellow-300" /><p className="mt-2 text-xs text-slate-300">Instant replies</p></div><div className="rounded-xl border border-white/10 bg-black/10 p-4"><Clock3 className="mx-auto h-5 w-5 text-cyan-300" /><p className="mt-2 text-xs text-slate-300">24/7</p></div><div className="rounded-xl border border-white/10 bg-black/10 p-4"><ShieldCheck className="mx-auto h-5 w-5 text-emerald-300" /><p className="mt-2 text-xs text-slate-300">Your data</p></div></div></div></div></section>
