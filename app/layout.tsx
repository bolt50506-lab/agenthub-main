...
export const metadata: Metadata = {
  ...
  title: {
    default: 'AgentHub AI | AI Business Automation & Customer Support',
    template: '%s | AgentHub AI',
  },
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName,
    title: 'AgentHub AI | AI Business Automation & Customer Support',
    description: siteDescription,
    locale: 'en_US',
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: 'AgentHub AI business automation across WhatsApp, Instagram, Facebook and website chat',
    }],
  },
  twitter: {
