...
export default function BillingPage() {
  ...
  const expired = searchParams.get('expired') === '1' || (daysLeft !== null && daysLeft <= 0) || ['expired','suspended','cancelled'].includes(sub?.status || '');
  ...
  return <div className="space-y-6">
    ...
    <Card className="border-violet-200 dark:border-violet-900/50"><CardHeader><CardTitle>Plans & limits</CardTitle><p className="text-sm text-muted-foreground">Your subscription controls the agents, conversations, leads, appointments, integrations, storage and AI usage available to this workspace.</p></CardHeader><CardContent>
