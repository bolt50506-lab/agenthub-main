...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (countryCode !== 'PK') setPaymentMethod('bank_transfer');
  }, [countryCode]);
    ...
    <main className="min-h-screen bg-[#070b18] text-white">
      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 lg:grid-cols-[1.05fr_.95fr] lg:py-16 sm:px-6">
        <section>
          ...
          <p className="mt-3 max-w-xl text-slate-400">Enter your account details, then pay manually and upload your payment screenshot. Pakistan checkout uses a live USD-to-PKR conversion; international checkout remains in USD. Your account and selected plan activate automatically after payment approval.</p>
        ...
        <aside className="lg:sticky lg:top-24 lg:h-fit">
          <div className="rounded-2xl border border-violet-500/30 bg-gradient-to-b from-violet-500/10 to-white/[0.02] p-6">
            ...
            <div className="mt-6 flex items-end gap-1 border-b border-white/10 pb-6"><span className="text-5xl font-bold">USD ${price}</span><span className="mb-2 text-sm text-slate-500">/{plan.billing_period}</span></div><p className="mt-3 text-xs text-slate-500">Pakistan customers will see the live PKR equivalent before payment.</p>
